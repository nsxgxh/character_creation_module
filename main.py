...
def attack(char_name: str, char_class: str) -> str:
    """Функция атаки персонажа в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция защиты персонажа в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция специального уменя персонажа в зависимости от класса."""
    if char_class == 'warrior':
